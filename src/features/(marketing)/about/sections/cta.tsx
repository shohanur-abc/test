...
// ============= MAIN COMPONENT =============
export default function AboutCTA({ title, description, primaryCta, secondaryCta }: IAboutCTA) {
    return (
        <Section>
...
const Description = ({ text }: { text: string }) => (
    <p className="text-lg text-primary-foreground/80 max-w-2xl mx-auto">{text}</p>
);

const Actions = ({ primary, secondary }: { primary: IAboutCTA['primaryCta']; secondary: IAboutCTA['secondaryCta'] }) => (
