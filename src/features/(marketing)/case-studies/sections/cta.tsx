...
// ============= MAIN COMPONENT =============
export default function CaseStudiesCTA({ title, description, perks, primaryCta, secondaryCta }: ICaseStudiesCTA) {
    return (
        <Section>
...
const Actions = ({ primary, secondary }: { primary: ICaseStudiesCTA['primaryCta']; secondary: ICaseStudiesCTA['secondaryCta'] }) => (
